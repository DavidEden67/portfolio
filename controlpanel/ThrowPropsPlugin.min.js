...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function ()
	{
		...
		_gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (t, e, i, r)
		{
			...
			}, l.to = function (t, i, r, l, h)
			{
				i.throwProps || (i = {
					throwProps: i
				}), 0 === h && (i.throwProps.preventOvershoot = !0), c = !0;
				var u = new e(t, l || 1, i);
				return u.render(0, !0, !0), u.vars.css ? (u.duration(y(s,
				{
					throwProps: n,
					ease: i.ease
				}, r, l, h)), u._delay && !u.vars.immediateRender ? u.invalidate() : o._onInitTween(s, a, u), c = !1, u) : (u.kill(), u = new e(t, y(t, i, r, l, h), i), c = !1, u)
			}, x._onInitTween = function (t, e, i)
			{
				this.target = t, this._props = [], o = this, a = e;
				var s, n, l, h, u, f, p, _, v, y = i._ease,
				...
				for (s in e)
					if ("resistance" !== s && "checkpoint" !== s && "preventOvershoot" !== s)
					{
						...
						f = m(u, y, T, x), _ = 0, h = "function" == typeof t[s], l = h ? t[s.indexOf("set") || "function" != typeof t["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : t[s], "object" == typeof n && (p = l + f, void 0 !== n.end && (n = d(n, p, n.max, n.min), c && (e[s] = g(n, e[s], "end"))), void 0 !== n.max && p > Number(n.max) ? w || n.preventOvershoot ? f = n.max - l : _ = n.max - l - f : void 0 !== n.min && Number(n.min) > p && (w || n.preventOvershoot ? f = n.min - l : _ = n.min - l - f)), this._overwriteProps[b] = s, this._props[b++] = {
							p: s,
							s: l,
							c1: f,
							c2: _,
			...
			{
				for (var i = this._props, r = i.length; --r > -1;)(t[i[r].p] || t.throwProps) && (i[r].r = e)
		...
		}, !0), _gsScope._gsDefine("utils.VelocityTracker", ["TweenLite"], function (t)
		{
			...
			return d.addProp = function (e, i)
			{
				if (!this._lookup[e])
				{
					var r = this.target,
						...
						o = this._firstVP;
					this._firstVP = this._lookup[e] = this._lookup[n] = o = new f(n !== e && 0 === e.indexOf("set") ? n : e, s, o), o.css = this.elem && (void 0 !== this.target.style[o.p] || a[o.p]), o.css && a[o.p] && !r._gsTransform && t.set(r,
					{
						x: "+=0",
						overwrite: !1
			...
			}, p.track = function (t, e, i)
			{
				var r = _(t),
					s = e.split(","),
					n = s.length;
				for (i = (i || "").split(","), r || (r = new p(t)); --n > -1;) r.addProp(s[n], i[n] || i[0]);
				return r
